...
@Component({
  selector: 'app-level-four-n',
  templateUrl: './level-four-n.component.html',
  styleUrls: ['./level-four-n.component.css']
})
export class LevelFourNComponent implements OnInit {
  ...
  openOptions(characterClass){
    ...
    if(characterClass === 'druid'){
      ...
      setTimeout(()=>{
        ...
        enemyName.innerHTML = "Samurai Priest";
        let enemyDescription = document.getElementsByClassName('enemyDescription')[0] as HTMLElement;
        enemyDescription.innerHTML = "Part of the samurai clan. These highly skilled individuals turned their back on society. They now use their skills to rob and murder.";
        let enemyPortrait = document.getElementsByClassName('enemyPortrait')[0] as HTMLElement;
        enemyPortrait.setAttribute('src','./assets/monster27.png');
        enemyPortrait.style.maxHeight = "150px";
        enemyPortrait.style.maxWidth = "100px";
        }
      ...
      setTimeout(()=>{
        let enemyName = document.getElementsByClassName('enemyName')[0] as HTMLElement;
        if(document.getElementsByClassName('enemyName')[0]){
        enemyName.innerHTML = "Samurai Brother";
        let enemyDescription = document.getElementsByClassName('enemyDescription')[0] as HTMLElement;
        enemyDescription.innerHTML = "Part of the samurai clan. These highly skilled individuals turned their back on society. They now use their skills to rob and murder.";
        let enemyPortrait = document.getElementsByClassName('enemyPortrait')[0] as HTMLElement;
        enemyPortrait.setAttribute('src','./assets/monster26.png');
        enemyPortrait.style.maxHeight = "150px";
        enemyPortrait.style.maxWidth = "100px";
        }
      ...
      setTimeout(()=>{
        let enemyName = document.getElementsByClassName('enemyName')[0] as HTMLElement;
        if(document.getElementsByClassName('enemyName')[0]){
        enemyName.innerHTML = "Ninja Samurai";
        let enemyDescription = document.getElementsByClassName('enemyDescription')[0] as HTMLElement;
        enemyDescription.innerHTML = "Part of the samurai clan. These highly skilled individuals turned their back on society. They now use their skills to rob and murder.";
        let enemyPortrait = document.getElementsByClassName('enemyPortrait')[0] as HTMLElement;
        enemyPortrait.setAttribute('src','./assets/monster25.png');
        enemyPortrait.style.maxHeight = "150px";
        enemyPortrait.style.maxWidth = "100px";
        }
  ...
  //monster1
  fullMonster1Life : number = 135;
  monster1Life : number = 135;
  //monster2
  fullMonster2Life : number = 130;
  monster2Life : number = 130;
  //monster3
  fullMonster3Life : number = 80;
  monster3Life : number = 80;
...
//HP DISPLAY SYSTEM
  ...
  if(document.getElementsByClassName('peasantHPBar')[0]){
    let peasantHP = document.getElementsByClassName('peasantHPBar')[0] as HTMLElement;
    let peasantHPChild = peasantHP.childNodes[0] as HTMLElement;
    peasantHPChild.style.width = `${peasantPercentageLife}%`;
  }
  if(!document.getElementsByClassName('peasant')[0]){
    if(document.getElementsByClassName('peasantHPBar')[0]){
      document.getElementsByClassName('peasantHPBar')[0].parentElement.removeChild(document.getElementsByClassName('peasantHPBar')[0]);
    }
  }
  ...
  rock(position){
    if(this.energy >= 5 && this.rockLocked == false){
      ...
      for(let i=0;i<16;i++){
        ...
        let stabSound = new Audio("./assets/peasantRockEffect.mp3");
        stabSound.play();
        this.energy -= 5;
        this.getMonstersAtStartOfGame();
        this.checkIfWon();   
  ...
  checkIfDefeated(){
    if(this.arrayOfClasses.length == 0){
      if(document.getElementsByClassName('levelOneF')){
        this.messageEvent.emit(this.levelFourCompletedN);
...
victoryDungeonAlert = false;
  ...
  selectTarget(monster1){
    ...
    if(document.getElementsByClassName(this.monsterCoor1)[0] && this.targetY > this.monsterY && !document.getElementsByClassName(this.monsterCoor1)[0].hasChildNodes()){
    ...
    }else if(document.getElementsByClassName(this.monsterCoor2)[0] && this.targetY < this.monsterY && !document.getElementsByClassName(this.monsterCoor2)[0].hasChildNodes() ){
      document.getElementsByClassName('monster1')[0].parentElement.removeChild(document.getElementsByClassName('monster1')[0]);
    ...
    }else if(document.getElementsByClassName(this.monsterCoor3)[0] && this.targetX > this.monsterX && !document.getElementsByClassName(this.monsterCoor3)[0].hasChildNodes() ){
      document.getElementsByClassName('monster1')[0].parentElement.removeChild(document.getElementsByClassName('monster1')[0]);
    ...
    }else if(document.getElementsByClassName(this.monsterCoor4)[0] && this.targetX < this.monsterX && !document.getElementsByClassName(this.monsterCoor4)[0].hasChildNodes() ){
      document.getElementsByClassName('monster1')[0].parentElement.removeChild(document.getElementsByClassName('monster1')[0]);
    ...
    this.moveX1 = this.monsterX;
    this.moveY1 = Number(document.getElementsByClassName('monster1')[0].parentElement.className.charAt(2)) + 4;

    this.moveX2 = this.monsterX;
    this.moveY2 = Number(document.getElementsByClassName('monster1')[0].parentElement.className.charAt(2)) - 4;

    this.moveY3 = this.monsterY;
    this.moveX3 = Number(document.getElementsByClassName('monster1')[0].parentElement.className.charAt(0)) + 4;

    this.moveY4 = this.monsterY;
    this.moveX4 = Number(document.getElementsByClassName('monster1')[0].parentElement.className.charAt(0)) - 4;
    ...
    if(document.getElementsByClassName(this.monsterCoor1)[0] && document.getElementsByClassName(this.monsterCoor1)[0].hasChildNodes() && checkEnemyOrAlly1.className.slice(12,18) == "target" ){
      ...
      this.pushedTargetY = Number(document.getElementsByClassName(this.monsterCoor1)[0].className.charAt(2))+1;
      this.sameTargetX = document.getElementsByClassName(this.monsterCoor1)[0].className.charAt(0);
      this.newPositionForTarget = `${this.sameTargetX}_${this.pushedTargetY}`;
      ...
      let node = document.createElement("B");                 // Create a <b> node
      let textnode = document.createTextNode("70 DMG!");         // Create a text node
      let willAppendToTarget = node.appendChild(textnode);
      DMGwarning.style.color = "red";      
      DMGwarning.appendChild(willAppendToTarget);  
      let roarSound = new Audio("./assets/priestMagicEffect.mp3");
        roarSound.play();    
      setTimeout(()=>{
      ...
      let maxOutHP = this[monsterTarget];
        let maxOutHP2 = maxOutHP -= 70;
          if(maxOutHP2 < 0 ){
            this[monsterTarget] = 0;
            monsterTarget1.parentElement.removeChild(monsterTarget1);
          }else{
            if(document.getElementsByClassName(this.newPositionForTarget)[0] && !document.getElementsByClassName(this.newPositionForTarget)[0].hasChildNodes()){
              console.log(this.newPositionForTarget);
              monsterTarget1.parentElement.removeChild(monsterTarget1);
              document.getElementsByClassName(this.newPositionForTarget)[0].appendChild(monsterTarget1);
            }
            this[monsterTarget] -= 70;
          }
      ...
      this.pushedTargetY = Number(document.getElementsByClassName(this.monsterCoor2)[0].className.charAt(2))-1;
      this.sameTargetX = document.getElementsByClassName(this.monsterCoor1)[0].className.charAt(0);
      this.newPositionForTarget = `${this.sameTargetX}_${this.pushedTargetY}`;
      ...
      let maxOutHP = this[monsterTarget];
        let maxOutHP2 = maxOutHP -= 70;
          ...
          this.pushedTargetX = Number(document.getElementsByClassName(this.monsterCoor3)[0].className.charAt(0))+1;
          this.sameTargetY = document.getElementsByClassName(this.monsterCoor3)[0].className.charAt(2);
          this.newPositionForTarget = `${this.pushedTargetX}_${this.sameTargetY}`;
        ...
        roarSound.play(); 
              ...
              let maxOutHP = this[monsterTarget];
                ...
                if(this.elementOfTarget){
                  ...
                  this.moveX1 = this.monsterX;
                  this.moveY1 = Number(document.getElementsByClassName('monster1')[0].parentElement.className.charAt(2)) + 2;
              
                  this.moveX2 = this.monsterX;
                  this.moveY2 = Number(document.getElementsByClassName('monster1')[0].parentElement.className.charAt(2)) - 2;
              
                  this.moveY3 = this.monsterY;
                  this.moveX3 = Number(document.getElementsByClassName('monster1')[0].parentElement.className.charAt(0)) + 2;
              
                  this.moveY4 = this.monsterY;
                  this.moveX4 = Number(document.getElementsByClassName('monster1')[0].parentElement.className.charAt(0)) - 2;
  ...
  if(document.getElementsByClassName('peasant')[0]){
    this.addHP();
    let referenceNode = document.getElementsByClassName('peasant')[0] as HTMLElement;
    let newNode = document.getElementsByClassName('peasantHPBar')[0] as HTMLElement;
    newNode.parentElement.removeChild(newNode);
    referenceNode.parentNode.insertBefore(newNode, referenceNode.nextSibling);
  }else if(document.getElementsByClassName('peasantHPBar')[0]){
    let newNode = document.getElementsByClassName('peasantHPBar')[0] as HTMLElement;
    newNode.parentElement.removeChild(newNode);
  }
  if(document.getElementsByClassName('warrior')[0]){
    ...
    newNode.parentElement.removeChild(newNode);
    referenceNode.parentNode.insertBefore(newNode, referenceNode.nextSibling);
  }else if(document.getElementsByClassName('warHPBar')[0]){
    let newNode = document.getElementsByClassName('warHPBar')[0] as HTMLElement;
    newNode.parentElement.removeChild(newNode);
  }
  if(document.getElementsByClassName('druid')[0]){
    ...
    newNode.parentElement.removeChild(newNode);
    referenceNode.parentNode.insertBefore(newNode, referenceNode.nextSibling);
  }else if(document.getElementsByClassName('druidHPBar')[0]){
    let newNode = document.getElementsByClassName('druidHPBar')[0] as HTMLElement;
    newNode.parentElement.removeChild(newNode);
  }
  if(document.getElementsByClassName('monster1')[0]){
