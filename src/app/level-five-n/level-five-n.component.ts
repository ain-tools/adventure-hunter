...
@Component({
  selector: 'app-level-five-n',
  templateUrl: './level-five-n.component.html',
  styleUrls: ['./level-five-n.component.css']
})
export class LevelFiveNComponent implements OnInit {
    ...
    if(characterClass === 'druid'){
      ...
      setTimeout(()=>{
        ...
        if(document.getElementsByClassName('enemyName')[0]){
          enemyName.innerHTML = "The Remnant";
          let enemyDescription = document.getElementsByClassName('enemyDescription')[0] as HTMLElement;
          enemyDescription.innerHTML = "This creature is part of the Old World. Unlike creatures from today, you can't sense any life energy from it. By Old World standards, this creature is quite weak. By New World standards, you're f*cked.";
  ...
  //monster1
  fullMonster1Life : number = 205;
  monster1Life : number = 205;
  //monster2
  ...
  checkIfDefeated(){
    if(this.arrayOfClasses.length == 0){
      if(document.getElementsByClassName('levelOneF')){
        this.messageEvent.emit(this.levelFiveCompletedN);
