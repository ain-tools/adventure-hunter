...
@Component({
  selector: 'app-level-five-d',
  templateUrl: './level-five-d.component.html',
  styleUrls: ['./level-five-d.component.css']
})
export class LevelFiveDComponent implements OnInit {
  ...
  openOptions(characterClass){
    ...
    if(characterClass === 'druid'){
      ...
      setTimeout(()=>{
        ...
        if(enemyName){
        enemyName.innerHTML = "Twillight Dragon";
        let enemyDescription = document.getElementsByClassName('enemyDescription')[0] as HTMLElement;
        enemyDescription.innerHTML = "Behold the pinnacle of power. You can sense an unnatural energy coming from it. This dragon was once banished in the parallel dimension, somehow it came back... Stronger than ever. ";
        let enemyPortrait = document.getElementsByClassName('enemyPortrait')[0] as HTMLElement;
        enemyPortrait.setAttribute('src','./assets/monster34.png');
        enemyPortrait.style.maxHeight = "250px";
      ...
      setTimeout(()=>{
        let enemyName = document.getElementsByClassName('enemyName')[0] as HTMLElement;
        if(enemyName){
          enemyName.innerHTML = "Ghetto Statue";
        let enemyDescription = document.getElementsByClassName('enemyDescription')[0] as HTMLElement;
        enemyDescription.innerHTML = "Immense power is channeled from it to the twillight dragon.";
        }
  ...
  //monster1
  fullMonster1Life : number = 825;
  monster1Life : number = 825;
  //monster2
...
victoryDungeonAlert = false;
  ...
  selectTarget(monster1,monster2){
    ...
    if(document.getElementsByClassName(this.monsterCoor1)[0] && document.getElementsByClassName(this.monsterCoor1)[0].hasChildNodes() && checkEnemyOrAlly1.className.slice(12,18) == "target" ){
      ...
      let node = document.createElement("B");                 // Create a <b> node
      let textnode = document.createTextNode("120 DMG!");         // Create a text node
      let willAppendToTarget = node.appendChild(textnode);
