...
@Component({
  selector: 'app-level-four-d',
  templateUrl: './level-four-d.component.html',
  styleUrls: ['./level-four-d.component.css']
})
export class LevelFourDComponent implements OnInit {
    ...
    if(characterClass === 'druid'){
      ...
      setTimeout(()=>{
        ...
        if(document.getElementsByClassName('enemyName')[0]){
                enemyName.innerHTML = "Frost Dragon";
        ...
        enemyPortrait.setAttribute('src','./assets/monster33.png');
  ...
  //monster1
  fullMonster1Life : number = 355;
  monster1Life : number = 355;
  //monster2
