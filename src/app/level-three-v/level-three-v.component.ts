...
@Component({
  selector: 'app-level-three-v',
  templateUrl: './level-three-v.component.html',
  styleUrls: ['./level-three-v.component.css']
})
export class LevelThreeVComponent implements OnInit {
  ...
  openOptions(characterClass){
    ...
    if(characterClass === 'druid'){
      ...
      setTimeout(()=>{
        ...
        enemyName.innerHTML = "Orc Warrior";
        ...
        enemyPortrait.setAttribute('src','./assets/monster15.png');
        }
      },100)
      ...
      setTimeout(()=>{
        let enemyName = document.getElementsByClassName('enemyName')[0] as HTMLElement;
        if(document.getElementsByClassName('enemyName')[0]){
         enemyName.innerHTML = "Goblin Warrior";
        let enemyDescription = document.getElementsByClassName('enemyDescription')[0] as HTMLElement;
        enemyDescription.innerHTML = "Goblins and orcs sometimes work together if they have a greater foe, in this case, humans.";
        let enemyPortrait = document.getElementsByClassName('enemyPortrait')[0] as HTMLElement;
        enemyPortrait.setAttribute('src','./assets/monster15&16.png');
        }
  ...
  //monster2
  fullMonster2Life : number = 60;
  monster2Life : number = 60;
  //monster3
  fullMonster3Life : number = 60;
  monster3Life : number = 60;
  ...
  checkIfDefeated(){
    if(this.arrayOfClasses.length == 0){
      if(document.getElementsByClassName('levelOneF')){
        this.messageEvent.emit(this.levelThreeCompletedV);
