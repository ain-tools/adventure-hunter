...
@Component({
  selector: 'app-level-five-v',
  templateUrl: './level-five-v.component.html',
  styleUrls: ['./level-five-v.component.css']
})
export class LevelFiveVComponent implements OnInit {
  ...
  ngOnInit() {
    this.HPbar = document.getElementsByClassName('monster2HPBar')[0] as HTMLElement;
    setInterval(()=>{
  ...
  openOptions(characterClass){
    ...
    if(characterClass === 'druid'){
      ...
      //hp.childNodes[0].style.width = `${magePercentageLife}%`;
      //hp.childNodes[0].innerHTML = `${mageLife}/${fullMageLife}`;
      ...
      this.warrior=false;
      //hp.style.display = "block";
      //hp.childNodes[0].style.width = `${mercenaryPercentageLife}%`;
      //hp.childNodes[0].innerHTML = `${mercenaryLife}/${fullMercenaryLife}`;
      ...
      this.warrior=false;
      //hp.style.display = "block";
      //hp.childNodes[0].style.width = `${necromancerPercentageLife}%`;
      //hp.childNodes[0].innerHTML = `${necromancerLife}/${fullNecromancerLife}`;
      ...
      this.warrior=false;
      //hp.style.display = "block";
      //hp.childNodes[0].style.width = `${peasantPercentageLife}%`;
      //hp.childNodes[0].innerHTML = `${peasantLife}/${fullPeasantLife}`;
      ...
      this.warrior=false;
      //hp.style.display = "block";
      //hp.childNodes[0].style.width = `${priestessPercentageLife}%`;
      //hp.childNodes[0].innerHTML = `${priestessLife}/${fullPriestessLife}`;
      ...
      this.druid=false;
      //hp.style.display = "block";
      //hp.childNodes[0].style.width = `${warriorPercentageLife}%`;
      //hp.childNodes[0].innerHTML = `${warriorLife}/${fullWarriorLife}`;
      ...
      this.druid=false;
      //hp.style.display = "block";
      //hp.childNodes[0].style.width = `${monster1PercentageLife}%`;
      //hp.childNodes[0].innerHTML = `${monster1Life}/${fullMonster1Life}`;
      setTimeout(()=>{
        let enemyName = document.getElementsByClassName('enemyName')[0] as HTMLElement;
        if(document.getElementsByClassName('enemyName')[0]){
         enemyName.innerHTML = "Orcish Witch Doctor";
        let enemyDescription = document.getElementsByClassName('enemyDescription')[0] as HTMLElement;
        enemyDescription.innerHTML = "Orcs are reknown for their cruelty. Their ancestors came from the floating Island Of Giants long ago, ever since then, the orcs and humans have been locked in wars and territory disputes.";
        let enemyPortrait = document.getElementsByClassName('enemyPortrait')[0] as HTMLElement;
        enemyPortrait.setAttribute('src','./assets/monster21.png');
        }
      ...
      this.druid=false;
      //hp.style.display = "block";
      //hp.childNodes[0].style.width = `${monster2PercentageLife}%`;
      //hp.childNodes[0].innerHTML = `${monster2Life}/${fullMonster2Life}`;
      setTimeout(()=>{
        let enemyName = document.getElementsByClassName('enemyName')[0] as HTMLElement;
        if(document.getElementsByClassName('enemyName')[0]){
                enemyName.innerHTML = "Summoned Skeleton";
        let enemyDescription = document.getElementsByClassName('enemyDescription')[0] as HTMLElement;
        enemyDescription.innerHTML = "Called upon by the orcish witch doctor.";
        let enemyPortrait = document.getElementsByClassName('enemyPortrait')[0] as HTMLElement;
        enemyPortrait.setAttribute('src','./assets/monster20.png');
        }

      },100)
    }else if(characterClass == 'monster3'){
      this.characterClass = 'monster3';
      this.monster = true;
      this.warrior = false;
      this.mage=false;
      this.mercenary=false;
      ...
      setTimeout(()=>{
        let enemyName = document.getElementsByClassName('enemyName')[0] as HTMLElement;
        if(document.getElementsByClassName('enemyName')[0]){
        enemyName.innerHTML = "Orc Swordsman";
        let enemyDescription = document.getElementsByClassName('enemyDescription')[0] as HTMLElement;
        enemyDescription.innerHTML = "Orcs are reknown for their cruelty. Their ancestors came from the floating Island Of Giants long ago, ever since then, the orcs and humans have been locked in wars and territory disputes.";
        let enemyPortrait = document.getElementsByClassName('enemyPortrait')[0] as HTMLElement;
        enemyPortrait.setAttribute('src','./assets/monster22.png');
        }
        
      },100)
    }else if(characterClass == 'monster4'){
      this.characterClass = 'monster4';
      this.monster = true;
      this.warrior = false;
      this.mage=false;
      this.mercenary=false;
  ...
  //monster1
  fullMonster1Life : number = 95;
  monster1Life : number = 95;
  //monster2
  fullMonster2Life : number = 30;
  monster2Life : number = 30;
  //monster3
  fullMonster3Life : number = 30;
  monster3Life : number = 30;
  //monster4
  fullMonster4Life : number = 30;
  monster4Life : number = 30;
...
//HP DISPLAY SYSTEM
  ...
  //monster3 HP
  let fullMonster3Life = this.fullMonster3Life;
  let monster3Life = this.monster3Life ;
  let monster3PercentageLife : number = this.monster3Life * 100 / this.fullMonster3Life;

    //monster4 HP
    let fullMonster4Life = this.fullMonster4Life;
    let monster4Life = this.monster4Life ;
    let monster4PercentageLife : number = this.monster4Life * 100 / this.fullMonster4Life;

  if(document.getElementsByClassName('warHPBar')[0]){
  ...
  if(!document.getElementsByClassName('warrior')[0]){
    if(document.getElementsByClassName('warHPBar')[0]){
      document.getElementsByClassName('warHPBar')[0].parentElement.removeChild(document.getElementsByClassName('warHPBar')[0]);
    }
  }
  if(document.getElementsByClassName('druidHPBar')[0]){
    let druidHP = document.getElementsByClassName('druidHPBar')[0] as HTMLElement;
    let druidHPChild = druidHP.childNodes[0] as HTMLElement;
    druidHPChild.style.width = `${druidPercentageLife}%`;
  }
  if(!document.getElementsByClassName('druid')[0]){
    if(document.getElementsByClassName('druidHPBar')[0]){
      document.getElementsByClassName('druidHPBar')[0].parentElement.removeChild(document.getElementsByClassName('druidHPBar')[0]);
    }
  }
      ...
      if(document.getElementsByClassName('monster3HPBar')[0]){
        let monster3HP = document.getElementsByClassName('monster3HPBar')[0] as HTMLElement;
        let monster3HPChild = monster3HP.childNodes[0] as HTMLElement;
        monster3HPChild.style.width = `${monster3PercentageLife}%`;
      }
      if(document.getElementsByClassName('monster4HPBar')[0]){
        let monster4HP = document.getElementsByClassName('monster4HPBar')[0] as HTMLElement;
        let monster4HPChild = monster4HP.childNodes[0] as HTMLElement;
        monster4HPChild.style.width = `${monster4PercentageLife}%`;
      }
  }
  ...
  heal(position){
    if(this.energy >= 10 && this.healLocked == false){
      ...
      let textnode = document.createTextNode("HEALED 20!");         // Create a text node
      ...
      for(let i=0;i<17;i++){
        ...
        if(document.getElementsByClassName('monster3')[0]){
          this.addHP();
          let referenceNode = document.getElementsByClassName('monster3')[0] as HTMLElement;
          let newNode = document.getElementsByClassName('monster3HPBar')[0] as HTMLElement;
          newNode.parentElement.removeChild(newNode);
          referenceNode.parentNode.insertBefore(newNode, referenceNode.nextSibling);
        }else if(document.getElementsByClassName('monster3HPBar')[0]){
          let newNode = document.getElementsByClassName('monster3HPBar')[0] as HTMLElement;
          newNode.parentElement.removeChild(newNode);
        }
        if(document.getElementsByClassName('monster4')[0]){
          this.addHP();
          let referenceNode = document.getElementsByClassName('monster4')[0] as HTMLElement;
          let newNode = document.getElementsByClassName('monster4HPBar')[0] as HTMLElement;
          newNode.parentElement.removeChild(newNode);
          referenceNode.parentNode.insertBefore(newNode, referenceNode.nextSibling);
        }else if(document.getElementsByClassName('monster4HPBar')[0]){
          let newNode = document.getElementsByClassName('monster4HPBar')[0] as HTMLElement;
          newNode.parentElement.removeChild(newNode);
        }
    }
  ...
  checkIfDefeated(){
    if(this.arrayOfClasses.length == 0){
      if(document.getElementsByClassName('levelOneF')){
        this.messageEvent.emit(this.levelFiveCompletedV);
...
victoryDungeonAlert = false;
  ...
  HPbar;
  selectTarget(monster1,monster2,monster3,monster4){
    ...
    let monster3Select = document.getElementsByClassName('monster3')[0] as HTMLElement;
    let monster4Select = document.getElementsByClassName('monster4')[0] as HTMLElement;
    ...
    let spectralDog = monster2;

    if(document.getElementsByClassName(this.monsterCoor1)[0] && !document.getElementsByClassName(this.monsterCoor1)[0].childNodes[0] && !document.getElementsByClassName('monster2')[0]){
      document.getElementsByClassName(this.monsterCoor1)[0].appendChild(spectralDog);
      document.getElementsByClassName(this.monsterCoor1)[0].appendChild(this.HPbar);
      this.monster2Life = 30;
      let summonSound = new Audio('./assets/summonMagicEffect.mp3')
      summonSound.play();
    }
    if(document.getElementsByClassName(this.monsterCoor2)[0] && !document.getElementsByClassName(this.monsterCoor2)[0].childNodes[0] && !document.getElementsByClassName('monster2')[0]){
      document.getElementsByClassName(this.monsterCoor2)[0].appendChild(spectralDog);
      document.getElementsByClassName(this.monsterCoor1)[0].appendChild(this.HPbar);
      this.monster2Life = 30;
      let summonSound = new Audio('./assets/summonMagicEffect.mp3')
      summonSound.play();
    }
    if(document.getElementsByClassName(this.monsterCoor3)[0] && !document.getElementsByClassName(this.monsterCoor3)[0].childNodes[0] && !document.getElementsByClassName('monster2')[0]){
      document.getElementsByClassName(this.monsterCoor3)[0].appendChild(spectralDog);
      document.getElementsByClassName(this.monsterCoor1)[0].appendChild(this.HPbar);
      this.monster2Life = 30;
      let summonSound = new Audio('./assets/summonMagicEffect.mp3')
      summonSound.play();
    }
    if(document.getElementsByClassName(this.monsterCoor4)[0] && !document.getElementsByClassName(this.monsterCoor4)[0].childNodes[0] && !document.getElementsByClassName('monster2')[0]){
      document.getElementsByClassName(this.monsterCoor4)[0].appendChild(spectralDog);
      document.getElementsByClassName(this.monsterCoor1)[0].appendChild(this.HPbar);
      this.monster2Life = 30;
      let summonSound = new Audio('./assets/summonMagicEffect.mp3')
      summonSound.play();
    ...
    if(document.getElementsByClassName(this.monsterCoor1)[0] && document.getElementsByClassName(this.monsterCoor1)[0].hasChildNodes() && checkEnemyOrAlly1.className.slice(12,18) == "target" ){
      ...
      let roarSound = new Audio("./assets/monsterSmashEffect.mp3");
        roarSound.play();    
      setTimeout(()=>{
  ...
  if(monster2Select && monster2Select.style.display != "none"){
    ...
    if(document.getElementsByClassName(this.monsterCoor1)[0] && document.getElementsByClassName(this.monsterCoor1)[0].hasChildNodes() && checkEnemyOrAlly1.className.slice(12,18) == "target" ){
      ...
      let DMGwarning = document.getElementsByClassName(this.monsterCoor1)[0] as HTMLElement;  
      let node = document.createElement("B");                 // Create a <b> node
      let textnode = document.createTextNode("25 DMG!");         // Create a text node
      let willAppendToTarget = node.appendChild(textnode);
      DMGwarning.style.color = "red";      
      DMGwarning.appendChild(willAppendToTarget);  
      let spiderSound = new Audio("./assets/goblinRoarEffect.mp3");
              spiderSound.play();       
      setTimeout(()=>{
        DMGwarning.removeChild(willAppendToTarget);
        if(!monsterTarget1){
      ...
      let maxOutHP = this[monsterTarget];
        let maxOutHP2 = maxOutHP -= 25;
          if(maxOutHP2 < 0 ){
            this[monsterTarget] = 0;
            monsterTarget1.parentElement.removeChild(monsterTarget1);
          }else{
            this[monsterTarget] -= 25;
          }
      this.getClassesAtStartOfGame();
      this.checkIfDefeated();
    }else if(document.getElementsByClassName(this.monsterCoor2)[0] && document.getElementsByClassName(this.monsterCoor2)[0].hasChildNodes() && checkEnemyOrAlly2.className.slice(12,18) == "target" ){
        ...
        let maxOutHP2 = maxOutHP -= 25;
          ...
          let maxOutHP = this[monsterTarget];
            let maxOutHP2 = maxOutHP -= 25;
              ...
              let DMGwarning = document.getElementsByClassName(this.monsterCoor4)[0] as HTMLElement;
              let node = document.createElement("B");                 // Create a <b> node
              let textnode = document.createTextNode("35 DMG!");         // Create a text node
              let willAppendToTarget = node.appendChild(textnode);
              DMGwarning.style.color = "red";      
              DMGwarning.appendChild(willAppendToTarget);   
              let spiderSound = new Audio("./assets/goblinRoarEffect.mp3");
  ...
  if(monster4Select && monster4Select.style.display != "none"){
    this.positionOfMonster = monster4.parentElement.className;
    this.monsterX = Number(this.positionOfMonster.charAt(0));
    this.monsterY = Number(this.positionOfMonster.charAt(2));
    this.distancesX = [];
    this.distancesY = [];
    ...
    this.moveX1 = this.monsterX;
    this.moveY1 = Number(document.getElementsByClassName('monster4')[0].parentElement.className.charAt(2)) + 1;

    this.moveX2 = this.monsterX;
    this.moveY2 = Number(document.getElementsByClassName('monster4')[0].parentElement.className.charAt(2)) - 1;

    this.moveY3 = this.monsterY;
    this.moveX3 = Number(document.getElementsByClassName('monster4')[0].parentElement.className.charAt(0)) + 1;

    this.moveY4 = this.monsterY;
    this.moveX4 = Number(document.getElementsByClassName('monster4')[0].parentElement.className.charAt(0)) - 1;
    ...
    if(document.getElementsByClassName(this.monsterCoor1)[0] && this.targetY > this.monsterY && !document.getElementsByClassName(this.monsterCoor1)[0].hasChildNodes() && this.monsterMovementHistory != this.monsterCoor1){
      document.getElementsByClassName('monster4')[0].parentElement.removeChild(document.getElementsByClassName('monster4')[0]);
      document.getElementsByClassName(this.monsterCoor1)[0].appendChild(monster2);
      if(this.toggle){
      this.monsterMovementHistory = this.monsterCoor1;
      this.toggle = false;
      ...
      document.getElementsByClassName('monster4')[0].parentElement.removeChild(document.getElementsByClassName('monster4')[0]);
      document.getElementsByClassName(this.monsterCoor2)[0].appendChild(monster4);
      if(this.toggle){
      this.monsterMovementHistory = this.monsterCoor2;
      this.toggle = false;
      }else{
      ...
      document.getElementsByClassName('monster4')[0].parentElement.removeChild(document.getElementsByClassName('monster4')[0]);
      document.getElementsByClassName(this.monsterCoor3)[0].appendChild(monster4);
      if(this.toggle){
      this.monsterMovementHistory = this.monsterCoor3;
      this.toggle = false;
      }else{
      ...
      document.getElementsByClassName('monster4')[0].parentElement.removeChild(document.getElementsByClassName('monster4')[0]);
      document.getElementsByClassName(this.monsterCoor4)[0].appendChild(monster4);
      if(this.toggle){
      this.monsterMovementHistory = this.monsterCoor4;
      this.toggle = false;
      }else{
    ...
    if(document.getElementsByClassName(this.monsterCoor1)[0] && document.getElementsByClassName(this.monsterCoor1)[0].hasChildNodes() && checkEnemyOrAlly1.className.slice(12,18) == "target" ){
      ...
      DMGwarning.style.color = "red";      
      DMGwarning.appendChild(willAppendToTarget);  
      let spiderSound = new Audio("./assets/warriorSlashEffect.mp3");
              spiderSound.play();       
      setTimeout(()=>{
        DMGwarning.removeChild(willAppendToTarget);
        if(!monsterTarget1){
  ...
  if(monster3Select && monster3Select.style.display != "none"){
    this.positionOfMonster = monster3.parentElement.className;
    this.monsterX = Number(this.positionOfMonster.charAt(0));
    this.monsterY = Number(this.positionOfMonster.charAt(2));
    this.distancesX = [];
    this.distancesY = [];
    ...
    this.moveX1 = this.monsterX;
    this.moveY1 = Number(document.getElementsByClassName('monster3')[0].parentElement.className.charAt(2)) + 1;

    this.moveX2 = this.monsterX;
    this.moveY2 = Number(document.getElementsByClassName('monster3')[0].parentElement.className.charAt(2)) - 1;

    this.moveY3 = this.monsterY;
    this.moveX3 = Number(document.getElementsByClassName('monster3')[0].parentElement.className.charAt(0)) + 1;

    this.moveY4 = this.monsterY;
    this.moveX4 = Number(document.getElementsByClassName('monster3')[0].parentElement.className.charAt(0)) - 1;
    ...
    if(document.getElementsByClassName(this.monsterCoor1)[0] && this.targetY > this.monsterY && !document.getElementsByClassName(this.monsterCoor1)[0].hasChildNodes() && this.monsterMovementHistory != this.monsterCoor1){
      document.getElementsByClassName('monster3')[0].parentElement.removeChild(document.getElementsByClassName('monster3')[0]);
      document.getElementsByClassName(this.monsterCoor1)[0].appendChild(monster3);
      if(this.toggle){
      this.monsterMovementHistory = this.monsterCoor1;
      this.toggle = false;
      }else{
      ...
      document.getElementsByClassName('monster3')[0].parentElement.removeChild(document.getElementsByClassName('monster3')[0]);
      document.getElementsByClassName(this.monsterCoor2)[0].appendChild(monster3);
      if(this.toggle){
      this.monsterMovementHistory = this.monsterCoor2;
      this.toggle = false;
      }else{
      ...
      document.getElementsByClassName('monster3')[0].parentElement.removeChild(document.getElementsByClassName('monster3')[0]);
      document.getElementsByClassName(this.monsterCoor3)[0].appendChild(monster3);
      if(this.toggle){
      this.monsterMovementHistory = this.monsterCoor3;
      this.toggle = false;
      }else{
      ...
      document.getElementsByClassName('monster3')[0].parentElement.removeChild(document.getElementsByClassName('monster3')[0]);
      document.getElementsByClassName(this.monsterCoor4)[0].appendChild(monster3);
      if(this.toggle){
      this.monsterMovementHistory = this.monsterCoor4;
      this.toggle = false;
      }else{
  ...
  clicker1(position){
    ...
    if(document.getElementsByClassName('druid')[0]){
      let referenceNode = document.getElementsByClassName('druid')[0] as HTMLElement;
      let newNode = document.getElementsByClassName('druidHPBar')[0] as HTMLElement;
      newNode.parentElement.removeChild(newNode);
      referenceNode.parentNode.insertBefore(newNode, referenceNode.nextSibling);
    }
    }
