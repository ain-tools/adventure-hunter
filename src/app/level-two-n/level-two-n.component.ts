...
@Component({
  selector: 'app-level-two-n',
  templateUrl: './level-two-n.component.html',
  styleUrls: ['./level-two-n.component.css']
})
export class LevelTwoNComponent implements OnInit {
  ...
  openOptions(characterClass){
    ...
    if(characterClass === 'druid'){
      ...
      setTimeout(()=>{
        ...
        enemyPortrait.setAttribute('src','./assets/monster24.png');
  ...
  //monster1
  fullMonster1Life : number = 85;
  monster1Life : number = 85;
  //monster2
  ...
  checkIfDefeated(){
    if(this.arrayOfClasses.length == 0){
      if(document.getElementsByClassName('levelOneF')){
        this.messageEvent.emit(this.levelTwoCompletedN);
...
victoryDungeonAlert = false;
  ...
  selectTarget(monster1,monster2,monster3){
    ...
    if(document.getElementsByClassName(this.monsterCoor1)[0] && document.getElementsByClassName(this.monsterCoor1)[0].hasChildNodes() && checkEnemyOrAlly1.className.slice(12,18) == "target" ){
      ...
      let roarSound = new Audio("./assets/warriorSlashEffect.mp3");
        roarSound.play();    
      setTimeout(()=>{
