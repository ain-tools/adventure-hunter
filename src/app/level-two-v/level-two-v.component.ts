...
@Component({
  selector: 'app-level-two-v',
  templateUrl: './level-two-v.component.html',
  styleUrls: ['./level-two-v.component.css']
})
export class LevelTwoVComponent implements OnInit {
  ...
  openOptions(characterClass){
    ...
    if(characterClass === 'druid'){
      ...
      setTimeout(()=>{
        ...
        enemyPortrait.style.width = "180px";
        }
      },100)
    }
  ...
  //monster1
  fullMonster1Life : number = 125;
  monster1Life : number = 125;
  //monster2
