...
@Component({
  selector: 'app-level-two-d',
  templateUrl: './level-two-d.component.html',
  styleUrls: ['./level-two-d.component.css']
})
export class LevelTwoDComponent implements OnInit {
  ...
  openOptions(characterClass){
    ...
    if(characterClass === 'druid'){
      ...
      setTimeout(()=>{
        ...
        enemyName.innerHTML = "Molten Dragon";
        ...
        enemyPortrait.setAttribute('src','./assets/monster31.png');
  ...
  //monster1
  fullMonster1Life : number = 325;
  monster1Life : number = 325;
  //monster2
