...
@Component({
  selector: 'app-level-one-d',
  templateUrl: './level-one-d.component.html',
  styleUrls: ['./level-one-d.component.css']
})
export class LevelOneDComponent implements OnInit {
  ...
  openOptions(characterClass){
    ...
    if(characterClass === 'druid'){
      ...
      setTimeout(()=>{
        ...
        enemyName.innerHTML = "Undead Dragon";
        ...
        enemyPortrait.setAttribute('src','./assets/monster30.png');
  ...
  //monster1
  fullMonster1Life : number = 305;
  monster1Life : number = 305;
  //monster2
  ...
  checkIfDefeated(){
    if(this.arrayOfClasses.length == 0){
      if(document.getElementsByClassName('levelOneF')){
        this.messageEvent.emit(this.levelOneCompletedD);
