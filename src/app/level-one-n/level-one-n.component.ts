...
@Component({
  selector: 'app-level-one-n',
  templateUrl: './level-one-n.component.html',
  styleUrls: ['./level-one-n.component.css']
})
export class LevelOneNComponent implements OnInit {
  ...
  openOptions(characterClass){
    ...
    if(characterClass === 'druid'){
      ...
      setTimeout(()=>{
        ...
        enemyName.innerHTML = "Bandit Samurai Archer";
        ...
        enemyPortrait.setAttribute('src','./assets/monster23.png');
      ...
      setTimeout(()=>{
        ...
        let enemyPortrait = document.getElementsByClassName('enemyPortrait')[0] as HTMLElement;
        enemyPortrait.setAttribute('src','./assets/monster13.png');
        }
      ...
      setTimeout(()=>{
        ...
        enemyDescription.innerHTML = "Orcs are reknown for their cruelty. Their ancestors came from the floating Island Of Giants long ago, ever since then, the orcs and humans have been locked in wars and territory disputes.";
        let enemyPortrait = document.getElementsByClassName('enemyPortrait')[0] as HTMLElement;
        enemyPortrait.setAttribute('src','./assets/monster14.png');
        }
  ...
  checkIfDefeated(){
    if(this.arrayOfClasses.length == 0){
      if(document.getElementsByClassName('levelOneF')){
        this.messageEvent.emit(this.levelOneCompletedN);
...
victoryDungeonAlert = false;
  ...
  selectTarget(monster1){
    ...
    this.moveX1 = this.monsterX;
    this.moveY1 = Number(document.getElementsByClassName('monster1')[0].parentElement.className.charAt(2)) + 3;

    this.moveX2 = this.monsterX;
    this.moveY2 = Number(document.getElementsByClassName('monster1')[0].parentElement.className.charAt(2)) + 4;

    this.moveY3 = this.monsterY;
    this.moveX3 = Number(document.getElementsByClassName('monster1')[0].parentElement.className.charAt(0)) + 3;
