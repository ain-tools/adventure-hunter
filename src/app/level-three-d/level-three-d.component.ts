...
@Component({
  selector: 'app-level-three-d',
  templateUrl: './level-three-d.component.html',
  styleUrls: ['./level-three-d.component.css']
})
export class LevelThreeDComponent implements OnInit {
  ...
  openOptions(characterClass){
    ...
    if(characterClass === 'druid'){
      ...
      setTimeout(()=>{
        ...
        enemyName.innerHTML = "Mountain Dragon";
        let enemyDescription = document.getElementsByClassName('enemyDescription')[0] as HTMLElement;
        enemyDescription.innerHTML = "This being possesses an ungodly amount of life energy. These creatures were once feared across the land until the legendary Dragon Knight Zarcost and his crew slayed them all, or so it seemed.";
        let enemyPortrait = document.getElementsByClassName('enemyPortrait')[0] as HTMLElement;
        enemyPortrait.setAttribute('src','./assets/monster32.png');
        enemyPortrait.style.maxHeight = "350px";
        enemyPortrait.style.maxWidth = "300px";
        }
      ...
      setTimeout(()=>{
        ...
        let enemyPortrait = document.getElementsByClassName('enemyPortrait')[0] as HTMLElement;
        enemyPortrait.setAttribute('src','./assets/monster29.png');
  ...
  //monster1
  fullMonster1Life : number = 345;
  monster1Life : number = 345;
  //monster2
...
//HP DISPLAY SYSTEM
  ...
  if(document.getElementsByClassName('mageHPBar')[0]){
    let mageHP = document.getElementsByClassName('mageHPBar')[0] as HTMLElement;
    let mageHPChild = mageHP.childNodes[0] as HTMLElement;
    mageHPChild.style.width = `${magePercentageLife}%`;
  }
  if(!document.getElementsByClassName('mage')[0]){
    if(document.getElementsByClassName('mageHPBar')[0]){
      document.getElementsByClassName('mageHPBar')[0].parentElement.removeChild(document.getElementsByClassName('mageHPBar')[0]);
    }
  }
  ...
  fireball(position){
    if(this.energy >= 15 && this.fireLocked == false){
      ...
      let node = document.createElement("B");                 // Create a <b> node
      let textnode = document.createTextNode("45 DMG!");         // Create a text node
      let willAppendToTarget = node.appendChild(textnode);
      ...
      for(let i=0;i<17;i++){
        ...
        this.energy -=15;
        let stabSound = new Audio("./assets/mageFireballEffect.mp3");
        stabSound.play();
  ...
  checkIfDefeated(){
    if(this.arrayOfClasses.length == 0){
      if(document.getElementsByClassName('levelOneF')){
        this.messageEvent.emit(this.levelTwoCompletedD);
...
victoryDungeonAlert = false;
  ...
  selectTarget(monster1){
    ...
    if(document.getElementsByClassName(this.monsterCoor1)[0] && document.getElementsByClassName(this.monsterCoor1)[0].hasChildNodes() && checkEnemyOrAlly1.className.slice(12,18) == "target" ){
      ...
      let node = document.createElement("B");                 // Create a <b> node
      let textnode = document.createTextNode("100 DMG!");         // Create a text node
      let willAppendToTarget = node.appendChild(textnode);
      DMGwarning.style.color = "red";      
      DMGwarning.appendChild(willAppendToTarget);  
      let roarSound = new Audio("./assets/MonsterSuperRoarEffect.mp3");
        roarSound.play();    
      setTimeout(()=>{
      ...
      this.sameTargetX = document.getElementsByClassName(this.monsterCoor2)[0].className.charAt(0);
      this.newPositionForTarget = `${this.sameTargetX}_${this.pushedTargetY}`;
        ...
        roarSound.play();     
          ...
          let maxOutHP = this[monsterTarget];
            let maxOutHP2 = maxOutHP -= 100;
              ...
              this.pushedTargetX = Number(document.getElementsByClassName(this.monsterCoor4)[0].className.charAt(0))+1;
              this.sameTargetY = document.getElementsByClassName(this.monsterCoor4)[0].className.charAt(2);
              this.newPositionForTarget = `${this.pushedTargetX}_${this.sameTargetY}`;
  ...
  if(document.getElementsByClassName('mage')[0]){
    this.addHP();
    let referenceNode = document.getElementsByClassName('mage')[0] as HTMLElement;
    let newNode = document.getElementsByClassName('mageHPBar')[0] as HTMLElement;
    newNode.parentElement.removeChild(newNode);
    referenceNode.parentNode.insertBefore(newNode, referenceNode.nextSibling);
  }else if(document.getElementsByClassName('mageHPBar')[0]){
    let newNode = document.getElementsByClassName('mageHPBar')[0] as HTMLElement;
    newNode.parentElement.removeChild(newNode);
  }
  if(document.getElementsByClassName('peasant')[0]){
