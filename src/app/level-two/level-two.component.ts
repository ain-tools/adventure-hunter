...
export class LevelTwoComponent implements OnInit {
    ...
    //  hp.childNodes[0].style.width = `${druidPercentageLife}%`;
      ...
      setTimeout(()=>{
        ...
        if(document.getElementsByClassName('enemyName')[0]){
          enemyName.innerHTML = "Goblin Treasure Hunter";
          let enemyDescription = document.getElementsByClassName('enemyDescription')[0] as HTMLElement;
          enemyDescription.innerHTML = "Goblins are a tribal species. Being subjected to slavery by many humanoid species made them quite distrustful of others. Their intelligence and cunning is what makes them thrive even after the hardships their race faced";
          let enemyPortrait = document.getElementsByClassName('enemyPortrait')[0] as HTMLElement;
          enemyPortrait.setAttribute('src','./assets/monster3.png');
        }
      },100)
      ...
      setTimeout(()=>{
        ...
        if(document.getElementsByClassName('enemyName')[0]){
          ...
          enemyDescription.innerHTML = "Goblins are a tribal species. Being subjected to slavery by many humanoid species made them quite distrustful of others. Their intelligence and cunning is what makes them thrive even after the hardships their race faced";
          let enemyPortrait = document.getElementsByClassName('enemyPortrait')[0] as HTMLElement;
          enemyPortrait.setAttribute('src','./assets/monster4.png');
        }
      },100)
  ...
  //monster1
  fullMonster1Life : number = 45;
  monster1Life : number = 45;
  //monster2
  fullMonster2Life : number = 40;
  monster2Life : number = 40;
  ...
  checkIfDefeated(){
    if(this.arrayOfClasses.length == 0){
      if(document.getElementsByClassName('levelOneF')){
        this.messageEvent.emit(this.levelTwoCompletedF);
...
victoryDungeonAlert = false;
  ...
  selectTarget(monster1,monster2){
    ...
    if(document.getElementsByClassName(this.monsterCoor1)[0] && document.getElementsByClassName(this.monsterCoor1)[0].hasChildNodes() && checkEnemyOrAlly1.className.slice(12,18) == "target" ){
      ...
      let roarSound = new Audio("./assets/goblinRoarEffect.mp3");
        roarSound.play();    
      setTimeout(()=>{
