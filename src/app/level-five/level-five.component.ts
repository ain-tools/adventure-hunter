...
dialogText1 = true;
  ...
  let monster4PercentageLife : number = this.monster4Life * 100 / this.fullMonster4Life;
    if(characterClass === 'druid'){
      ...
      //hp.childNodes[0].style.width = `${druidPercentageLife}%`;
      //hp.childNodes[0].innerHTML = `${druidLife}/${fullDruidLife}`;
     ...
     // hp.childNodes[0].innerHTML = `${mageLife}/${fullMageLife}`;
      ...
      setTimeout(()=>{
        ...
        enemyName.innerHTML = "Warlock";
        let enemyDescription = document.getElementsByClassName('enemyDescription')[0] as HTMLElement;
        enemyDescription.innerHTML = "You can feel a dark aura surrounding this thing. Is it even human anymore? Warlocks usually hide in catacombs where they can do disgusting experiments on corpses.";
        let enemyPortrait = document.getElementsByClassName('enemyPortrait')[0] as HTMLElement;
        enemyPortrait.setAttribute('src','./assets/monster8.png');
        }
      },100)
      ...
      setTimeout(()=>{
        let enemyName = document.getElementsByClassName('enemyName')[0] as HTMLElement;
        if(document.getElementsByClassName('enemyName')[0]){
        enemyName.innerHTML = "Legendary Corrupted Warrior.";
        let enemyDescription = document.getElementsByClassName('enemyDescription')[0] as HTMLElement;
        enemyDescription.innerHTML = "Another member from the 'Adventurer Co.' This one looks similar to the mage you slain back at the bridge, perhaps he is her brother? You can see that this one is corrupted like the other two.";
        let enemyPortrait = document.getElementsByClassName('enemyPortrait')[0] as HTMLElement;
        enemyPortrait.setAttribute('src','./assets/monster9.png');
        }
      },100)
      ...
      this.druid=false;
      //hp.style.display = "block";
      //hp.childNodes[0].style.width = `${monster3PercentageLife}%`;
      //hp.childNodes[0].innerHTML = `${monster3Life}/${fullMonster3Life}`;
      setTimeout(()=>{
        let enemyName = document.getElementsByClassName('enemyName')[0] as HTMLElement;
        if(document.getElementsByClassName('enemyName')[0]){
        enemyName.innerHTML = "Corrupted Bugman";
        let enemyDescription = document.getElementsByClassName('enemyDescription')[0] as HTMLElement;
        enemyDescription.innerHTML = "Bugmen are peaceful creatures that came alive from rocks and moss after the druid Malacath died,releasing his powerful energy throughout this forest.";
        let enemyPortrait = document.getElementsByClassName('enemyPortrait')[0] as HTMLElement;
        enemyPortrait.setAttribute('src','./assets/monster10.png');
        }
      },100)
      ...
      this.druid=false;
      //hp.style.display = "block";
      //hp.childNodes[0].style.width = `${monster4PercentageLife}%`;
      //hp.childNodes[0].innerHTML = `${monster4Life}/${fullMonster4Life}`;
      setTimeout(()=>{
        let enemyName = document.getElementsByClassName('enemyName')[0] as HTMLElement;
        if(document.getElementsByClassName('enemyName')[0]){
        enemyName.innerHTML = "Corrupted Bugman";
  ...
  //monster1
  fullMonster1Life : number = 8;
  monster1Life : number = 8;
  //monster2
  fullMonster2Life : number = 50;
  monster2Life : number = 50;
  //monster3
  fullMonster3Life : number = 50;
  monster3Life : number = 50;
  //monster3
  fullMonster4Life : number = 50;
  monster4Life : number = 50;
  addHP(){
    //HP DISPLAY SYSTEM
      //druid HP
      let fullDruidLife = this.fullDruidLife;
  ...
  checkIfDefeated(){
    if(this.arrayOfClasses.length == 0){
        if(document.getElementsByClassName('levelOneF')){
          this.messageEvent.emit(this.levelFiveCompletedF);
...
victoryDungeonAlert = false;
  ...
  selectTarget(monster2,monster3,monster4){
    let monster1Select = document.getElementsByClassName('monster2')[0] as HTMLElement;
    let monster2Select = document.getElementsByClassName('monster3')[0] as HTMLElement;
    let monster3Select = document.getElementsByClassName('monster4')[0] as HTMLElement;
  ...
  if(monster2Select && monster2Select.style.display != "none"){
    ...
    if(document.getElementsByClassName(this.monsterCoor1)[0] && document.getElementsByClassName(this.monsterCoor1)[0].hasChildNodes() && checkEnemyOrAlly1.className.slice(12,18) == "target" ){
      ...
      DMGwarning.style.color = "red";      
      DMGwarning.appendChild(willAppendToTarget);  
      let spiderSound = new Audio("./assets/monsterRoar.mp3");
              spiderSound.play();       
      setTimeout(()=>{
        DMGwarning.removeChild(willAppendToTarget);
        if(!monsterTarget1){
    ...
    if(document.getElementsByClassName(this.monsterCoor1)[0] && this.targetY > this.monsterY && !document.getElementsByClassName(this.monsterCoor1)[0].hasChildNodes() && this.monsterMovementHistory != this.monsterCoor1){
      ...
      document.getElementsByClassName(this.monsterCoor1)[0].appendChild(monster4);
      if(this.toggle){
      this.monsterMovementHistory = this.monsterCoor1;
      this.toggle = false;
      }else{
